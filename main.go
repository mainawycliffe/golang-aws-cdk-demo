...
type GolangAwsCdkDemoStackProps struct {
	awscdk.StackProps
}

func NewGolangAwsCdkDemoStack(scope constructs.Construct, id string, props *GolangAwsCdkDemoStackProps) awscdk.Stack {
