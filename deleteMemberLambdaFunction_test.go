...
func Test_deleteMemberLambdaFunction(t *testing.T) {
	type args struct {
		stack awscdk.Stack
	}
	...
	deleteMemberLambdaFunction(stack, table)
	...
	template.HasResourceProperties(jsii.String("AWS::IAM::Policy"), map[string]interface{}{
		...
		"Roles": assertions.Match_ArrayWith(
			&[]interface{}{
				map[string]interface{}{
					"Ref": assertions.Match_StringLikeRegexp(jsii.String("deleteMemberLambdaFunctionServiceRole*")),
				},
			},
		),
	})
