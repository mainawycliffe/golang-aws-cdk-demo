...
func Test_getMemberLambdaFunction(t *testing.T) {
	...
	getMemberLambdaFunction(stack, table)
	...
	template.HasResourceProperties(jsii.String("AWS::IAM::Policy"), map[string]interface{}{
		...
		"Roles": assertions.Match_ArrayWith(
			&[]interface{}{
				map[string]interface{}{
					"Ref": assertions.Match_StringLikeRegexp(jsii.String("getMemberLambdaFunctionServiceRole*")),
				},
			},
		),
	})
